...
def verify_random_int_works(num_tests: int = 100):
    min_value: int = 1
    max_value: int = 6
    ...
    print(f'{num_tests = }, {frequency = }')


def verify_random_float_with_tolerance_works(num_tests: int = 1_000):
    min_value: float = 1.0
    max_value: float = 6.0
    ...
    frequency =   {'min': 0, 'max': 0}
    for test in range(num_tests):
        nums = RandomNumberUtilities.random_float_with_tolerance(min_value, max_value, 0.01, 20)
...
def verify_random_float_works(num_tests: int = 100):
    min_value: float = 1.0
    max_value: float = 6.0
